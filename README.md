...
COSItools/cosiflow/data/obs/2025_01/250101/auxil/DC3_final_530km_3_month_with_slew_15sbins_GalacticEarth_SAA.ori
```
...
## Check the results
The Airflow UI will show the cosidag_source was successful. You can find the results in the ```cosiflow/data/source/crab``` directory (you might have to make this directory first) and there should be 8 files produced:
1. bin_crab_dc3.yaml
2. bin_Background_Model.yaml
3. tsel_unbinned_data_crab_dc3.fits (178 MB)
4. tsel_binned_data_galactic_crab_dc3.hdf5 (3.6 MB)
5. tsel_unbinned_data_Background_Model.fits (6.3 GB)
6. tsel_binned_data_galactic_Background_Model.hdf5 (69 MB)
7. results_pw.h5
